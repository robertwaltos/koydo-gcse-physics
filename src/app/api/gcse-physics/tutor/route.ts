...
const EXAM_ID = "gcse-physics";
const EXAM_DISPLAY_NAME = "GCSE Physics";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover Forces, Energy, Waves, Electricity, Magnetism, Particle Model, Atomic Structure, and Space Physics. Align to AQA GCSE Physics specification.
