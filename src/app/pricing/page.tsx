...
export const metadata: Metadata = {
  title: "Pricing — Gcse Physics Premium",
  description: "Unlock unlimited Gcse Physics practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=gcse-physics&cadence=annual`;
